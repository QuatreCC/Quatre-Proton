...
export default class Search extends Component<Props, States> {
  ...
  openSearchInExplorer = () => {
    ...
    remote.shell.openExternal(
      `http://explorer.node.quatre.cc/?hash=${encodeURIComponent(query)}#blockchain_transaction`
    );
  };
  ...
  openInExplorer = (event: any) => {
    ...
    remote.shell.openExternal(
      `http://explorer.node.quatre.cc/?hash=${encodeURIComponent(hash)}#blockchain_transaction`
    );
  };
                                ...
                                <tbody>
                                  <tr className="no-hover">
                                    ...
                                    <td>
                                      ...
                                      >
                                        {atomicToHuman(amount, true)} QUATRE
                                      </p>
                                      <br />
                                      <br />
                                      <button
