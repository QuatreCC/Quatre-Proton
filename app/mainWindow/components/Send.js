        ...
        const modalMessage = (
          <div>
            ...
            <p className={`subtitle ${textColor}`}>
              ...
              <br />
              {atomicToHuman(amount + nodeFee + fee, true)} QUATRE
            </p>
            <p className={`subtitle ${textColor}`}>
              <b>Fee:</b>
              <br />
              {atomicToHuman(nodeFee + fee, true)} QUATRE
              {nodeFee > 0 &&
    ...
    const addressInput = (
      ...
      >
        <Creatable
          ...
          placeholder="Enter a Quatre address or a contact name to send funds to"
